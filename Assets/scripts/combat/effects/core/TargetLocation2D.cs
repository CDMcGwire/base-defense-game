...
public readonly struct TargetLocation2D {
	/// <summary>The collider hit by the targeting logic.</summary>
	...
	/// <summary>
	///   The Unity Instance ID that should be associated with the target. From the
	///   rigidbody if present, else just the collider's.
	/// </summary>
